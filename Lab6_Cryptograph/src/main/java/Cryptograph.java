...
public class Cryptograph {
    ...
    //метод використовується для розшифровки даних
    ...
    // у даному методі шифруємо дані і записуємо у файл
    ...
    //у даному методі розшифровуємо дані з файлу та повертаємо їх строкою
    ...
    public static void main(String[] args) {
        ...
        String data="Hello.What is your name?";
        System.out.println("Вхідні дані : " + data);
        System.out.println("Шифруємо та записуємо дані у файл.\nЗашифровані дані : " + encryptDataAndWrite(data,file));
